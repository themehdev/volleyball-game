...
func _process(_delta):
	$LeftFoot.rect_global_position += (left_foot - $LeftFoot.rect_global_position) / 4
	$RightFoot.rect_global_position += (right_foot - $RightFoot.rect_global_position) / 4
	$RightHand.rect_global_position += (right_hand - $RightHand.rect_global_position) / 4
	$LeftHand.rect_global_position += (left_hand - $LeftHand.rect_global_position) / 4
	$Body.rect_global_position += (body - $Body.rect_global_position) / 40
	$Head.rect_global_position += (head - $Head.rect_global_position) / 40
